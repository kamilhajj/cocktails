...
export async function searchcocktail(searchterm: string) {
...
export async function searchcocktailbyfirstletter(letter: string) {
...
export async function  Searchingredientbyname(ingredient: string) {

    try {
        const response = await axios.get(` https://www.thecocktaildb.com/api/json/v1/1/search.php?i=${ingredient}`);
